...
abstract public class AbUppCvpDB extends AbCommonDB{

	private ArrayList<String> evHinfRefList = new ArrayList<String>();
	private ArrayList<String> evIcRefList = new ArrayList<String>();
	...
	public ArrayList<String> getEvIcRefList() {
		return evIcRefList;
	}
	public void setEvIcRefList(ArrayList<String> evIcRefList) {
		this.evIcRefList = evIcRefList;
	}
